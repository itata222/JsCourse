...
var PersonMaker = function PersonMaker(name, theId) {
  this.name = name;
  var id = theId;
  ...
  this.toString = function () {
    return "name: ".concat(this.name, "; id: ").concat(id);
  };
};
...
console.log(PersonMaker.prototype); // PersonMaker.prototype.toString = function () {
//     return `name: ${this.name}; id: ${this.id}`
// }

console.log(PersonMaker.prototype);
var moshe = new PersonMaker('moshe', "gchgvhj");
console.log(moshe.toString());
console.log(moshe);
console.log(moshe.hasOwnProperty('toString'));
moshe.setId('123456');
console.log(moshe.toString());
var shir = new PersonMaker('shir', '7786876');
console.log(PersonMaker.personsCount);
PersonMaker.setPersonsCount(77);
console.log(PersonMaker.getPersonsCount()); // ירושה
...
console.log(pawn instanceof ChessPiece); //  תרגיל צרו מחלקה של מלבן עם פונקציות של החזרת היקף ושטח ותוסטרינג
...
Square.prototype.toString = function () {
  return "Square - side length: ".concat(this.sideLength);
};
